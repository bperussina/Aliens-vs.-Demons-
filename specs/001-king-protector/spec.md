...
**Input**: Title menu, then Single Player: Level at the top, 10-second combat countdown, King Demon cutscene (chair only, he does not enter the fight), then waves of normal demons. Auto turret bullets deal half a quarter of four-quarter health. Number-key elemental skills. $10 per normal demon, saved. Wave 50 wins the round and levels up. Multiplayer level-making unlocks at level 50 and $1000.
...
### User Story 3 - Waves, turret, and skills (Priority: P1)

Normal demons have four quarters of health. The PC turret auto-fires bullets. Each bullet does half of one quarter (one-eighth of total health), so eight hits kill. Number keys 1–8 fire elemental and imaginary skills. Killing a normal demon grants $10 that is saved.

**Acceptance Scenarios**:

1. **Given** a normal demon, **When** turret bullets hit it, **Then** its four-quarter bar drops by half a quarter each hit and it dies on the eighth hit.
...
### User Story 5 - King still guards the PC (Priority: P1)

PC stays in the middle. The cardboard-box king is still click-moved. Esc returns to the menu.
...
- **FR-006**: Normal demons MUST have four visible health quarters. A turret bullet MUST deal half of one quarter (8 hits to kill).
- **FR-007**: The PC MUST auto-fire a turret at demons.
...
- **FR-013**: Click-move king, robot WASD, PC in the center, no pixel art.

## Key Entities

- **PC** + **Turret**, **King** (ally), **Robot**, **Normal Demon**, **King Demon** (cutscene only), **Wave**, **Coins**, **Level**
...
- **SC-004**: Eight turret hits kill a normal demon; coins go up $10 and persist.
